...
public class DataPlotter2D : MonoBehaviour
{
    class DataForPlotting
    {
        ...
        public DataForPlotting(string xname, string yname)
        {
            xName = xname;
            yName = yname;
            xMin = 0;
    ...
    void Start()
    {
        ...
        SetDataForPlotting(out plot1data, columnList[plot1columnX], columnList[plot1columnY]);
        SetDataForPlotting(out plot2data, columnList[plot2columnX], columnList[plot2columnY]);
        SetDataForPlotting(out plot3data, columnList[plot3columnX], columnList[plot3columnY]);
        ...
        if (renderPointPrefabs == true)
        {
            ...
            AssignLabels(4, plot1data, "PCA");
            AssignLabels(5, plot2data, "MDS");
            AssignLabels(6, plot3data, "LLE");
    ...
    private void AssignLabels(int number, DataForPlotting data, string method_name)
    {
        ...
        Debug.Log("Number of subjects: " + pointList.Count.ToString("0"));
        GameObject.Find("Count_Description" + postfix);
